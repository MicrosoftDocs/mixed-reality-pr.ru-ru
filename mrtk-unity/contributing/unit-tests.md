...
Тесты режима редактирования выполняются в режиме редактирования Unity и могут быть добавлены в папку **мртк**  >  **Tests**  >  **едитмодетестс** в репозитории набора средств Mixed Reality.
...
1. Переход к пункту меню "набор средств" смешанной реальности
