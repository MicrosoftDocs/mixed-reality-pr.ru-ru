...
* Жесты HoloLens
* Отслеживание в HoloLens с сочленением 2
* Отслеживание глаз HoloLens 2
* Контроллеры устройств VR

Для управления имитацией устройств во время выполнения пользователи могут использовать обычную клавиатуру и сочетание мыши. Такой подход позволяет тестировать взаимодействия в редакторе Unity без предварительного развертывания на устройстве.
...
Имитация ввода включена по умолчанию в профилях, поставляемых с МРТК.

В конфигурации поставщика входных системных данных для службы моделирования ввода можно настроить следующие параметры.

* **Тип** должен быть *Microsoft. микседреалити. Toolkit. Input > инпутсимулатионсервице*.
...
> ![Поддерживаемые платформы для моделирования входных данных](../images/input-simulation/InputSimulationSupportedPlatforms.gif)

## <a name="input-simulation-tools-window"></a>Окно средств моделирования ввода

Включите окно средства моделирования входных данных из   >    >  меню **моделирования ввода** служебных программ для смешанной реальности. Это окно предоставляет доступ к состоянию имитации ввода в режиме воспроизведения.

## <a name="viewport-buttons"></a>Кнопки окна просмотра
