...
:::row:::
    ...
    :::column-end:::
    :::column:::
    ![](../images/button/MRTK_Button_Checkbox.png) **Флажок** флажка
    :::column-end:::
    :::column:::
...
**Взаимодействие** 
 [Взаимодействие](interactable.md) обрабатывает различные типы состояний взаимодействия и событий. HoloLens взгляд, жест, речевой ввод и иммерсивное устройство ввода в головной гарнитуре непосредственно обрабатываются этим сценарием.
...
(набор средств, > служебные программы — > окно миграции — > выбор обработчика миграции — > Microsoft. микседреалити. набор средств. Utilities. Буттонконфигхелпермигратионхандлер)
