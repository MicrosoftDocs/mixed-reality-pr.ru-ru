...
|:-----------------------------|:----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Режим редактирования маски               | Режимы редактирования для определения границ маскирования блочной рамки. Выберите "Авто", чтобы автоматически использовать значения разбивки на страницы. Выберите "вручную", чтобы включить прямую манипуляцию с объектом обтравочного прямоугольника.|
| Режим редактирования для режима           | Режимы редактирования для определения границ механизма прокрутки при прокрутке. Выберите "Авто", чтобы автоматически использовать значения разбивки на страницы. Выберите "вручную", чтобы включить прямую манипуляцию с конфликтом.|
...
| События|    Description                                                                                                                                                                                 |
|-------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| По щелчку       | Событие, запускаемое при получении щелчком элемента, выполняющегося в фоновом режиме прокрутки или любого его интерактивного содержимого.                                                                                        |
| При запуске сенсорного ввода     | Событие, запускаемое, когда при прокрутке фона или любом из его интерактивного содержимого получается близкое касание.                                                                                                                                                        |
| При завершении сенсорного ввода     | Событие активируется при завершении активного сенсорного взаимодействия, когда указатель NEAR-взаимодействия пересекает одну из пороговых плоскостей выпуска. |
| В момент начала работы     | Событие активируется, когда контейнер прокрутки начинает перемещаться по взаимодействию, фаллоффф скорости или разбиению на страницы. |
| При завершении импульса     | Событие активируется, когда контейнер прокрутки прекращает перемещаться по взаимодействию, фаллоффф скорости или разбиению на страницы. |
