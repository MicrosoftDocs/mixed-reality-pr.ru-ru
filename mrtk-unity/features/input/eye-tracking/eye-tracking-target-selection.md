...
**1. включить элемент** управления "рука". чтобы включить луч, перейдите в раздел " _Смешанная реальность" Toolkit-> "входные > указатели_".
В _эйетраккингдемо-00-рутсцене_ , где набор средств Mixed Reality настроен один раз для всех демонстрационных сцен отслеживания взгляда, вы должны увидеть _эйетраккингдемопоинтерпрофиле_.
