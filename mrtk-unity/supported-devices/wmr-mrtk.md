...
---
# <a name="building-and-deploying-mrtk-uwp"></a>Сборка и развертывание МРТК (UWP)
...
## <a name="building-and-deploying-mrtk-standalone"></a>Сборка и развертывание МРТК (автономная версия)
