...
мы хотели воспользоваться всеми преимуществами HoloLens для отрисовки трехмерных объектов непосредственно в своем собственном пространстве, поэтому мы решили создать реалистичный взгляд на galaxy, где люди смогут увеличить и увидеть отдельные звезды, каждый на своем собственном траекторий.
...
проблема с созданием анимированного galaxy, которому были выделены миллиарды звезд, заключается в том, что количество отдельных элементов, нуждающихся в обновлении, будет слишком большим для HoloLens для анимации с использованием цп. Наше решение потребовало сложного сочетания искусства и науки.
...
мы открыли код для приложения Galaxy Explorer и сделали его доступным на [GitHub](https://github.com/Microsoft/GalaxyExplorer) для разработчиков.

Хотите узнать больше о процессе разработки для Galaxy Explorer? ознакомьтесь со всеми прошлыми обновлениями проекта на [Microsoft HoloLens канале YouTube](https://www.youtube.com/playlist?list=PLZCHH_4VqpRj0Nl46J0LNRkMyBNU4knbL).
...
* [Galaxy Explorer на GitHub](https://github.com/Microsoft/GalaxyExplorer)
