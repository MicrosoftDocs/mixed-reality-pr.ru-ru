...
>примечание. в HoloLens 2 необходимо сначала вызвать курсор «взгляд», выполнив слово «select». Скажите "выбрать" еще раз для активации. Чтобы скрыть курсор Взгляните, просто используйте руки, чтобы аиртап или коснуться объекта. 
...
* Чтобы Кортана начала слушать, скажите **Привет, Кортана!**. можно задать свои вопросы («эй Кортана, насколько высота Eiffel башня?»), сообщить ему о необходимости открыть приложение («эй, Кортана, open Netflix») или дать ему меню «пуск» («эй Кортана, взять мне домой») и многое другое.
