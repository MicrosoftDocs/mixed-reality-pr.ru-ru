...
|11:8:00-11:25am|*Сеанс 1* Что такое смешанная реальность?Что можно сделать с помощью HL2?Технический стек «MR»|TBD|JA|100|
|11:10:30-11:55am|*Сеанс 2* Пример внедрения коммерческого рынка в Японии с клиентами и партнерами|TBD|JA|200|
|12:12:00-12:50pm|*Сеанс обеда* Панель: интерактивное бесплатное обсуждение, Q и A, МРТК + Окулус Quest 2|TBD|JA|200|
|12:50pm-1:12:00|**Разбиени**||||
|1:12:00-1:25pm|*Сеанс 3* Обзор разработки HoloLens 2|TBD|JA|200|
|1:30-1:55pm|*Сеанс 4* HoloLens 2 & МРТК v 2.5 (МРТК-Unity)|TBD|JA|300|
|2:12:00-2:20pm|*Сеанс 5* Начало работы с HoloLens 2 и нереальными подсистемами (МРТК-Real)|TBD|RU|300|
|2:30-2:55pm|*Сеанс 6* Разработка приложений MR (рекомендуется для создания пользовательского интерфейса или UX для приложения HL2)|TBD|RU|300|
|2:55pm-3:17:15|**Разбиени**||||
|3:17:15-3:40pm|*Сеанс 7* Привязки объектов Azure|TBD|RU|300|
|3:17:45-4:10pm|*Сеанс 8* Удаленная подготовка к просмотру Azure|TBD|JA|300|
|4:17:15-4:40pm|*Сеанс 9* Пространственные привязки Azure|TBD|RU|300|
|4:17:45-5:10pm|*Сеанс 10* Инструмент блокировки мира|TBD|RU|300|
|5:17:15-5:40pm|*Сеанс 11* Пример использования Azure Kinect DK|TBD|JA|400|
|5:17:45-6:12:00|Закрытие|TBD|JA|Н/Д|
||||||
