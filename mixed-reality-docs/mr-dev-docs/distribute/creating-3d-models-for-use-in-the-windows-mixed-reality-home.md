...
> [!NOTE]
> Полный список возможностей для точных ограничений модели см. в статье [Оптимизация 3D-модели](https://docs.microsoft.com/dynamics365/mixed-reality/guides/3d-content-guidelines/optimize-models) для использования в приложениях Dynamics 365.
...
Ресурс Глтф должен указывать на сцену по умолчанию, используя атрибут сцены для отображения в Windows MR. Кроме того, загрузчик Windows Глтф перед [обновлением Windows 10 от апреля 2018](https://docs.microsoft.com/windows/mixed-reality/enthusiast-guide/release-notes-april-2018) **требует наличия** методов доступа:
