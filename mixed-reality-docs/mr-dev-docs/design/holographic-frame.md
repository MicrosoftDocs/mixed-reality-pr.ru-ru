...
В holographic кадре представлен инструмент, позволяющий разработчикам активировать взаимодействия и оценивать, где двеллс внимание пользователя. [взгляните](gaze-and-commit.md) одно из [ключевых взаимодействий на HoloLens](interaction-fundamentals.md), где взгляд можно связать с [жестами](gaze-and-commit.md#composite-gestures) (например, при касании воздуха) или [голоса](voice-input.md) (что позволяет более короткие и естественные взаимодействия на основе голоса). Таким образом, с помощью этого пакета holographic проявляется пространство для просмотра цифрового содержимого и взаимодействия с ним. Если интерфейс взаимодействует с несколькими объектами в пространстве пользователя (например, множественный выбор объектов вокруг пространства пользователя с помощью команды «Взгляните + жест»), рассмотрите возможность переноса этих объектов в представление пользователя или ограничения необходимого головного перемещения для повышения [удобства работы пользователей](comfort.md).
...
если вы хотите увидеть основные понятия проектирования для отслеживания изменений в голову и в действии, ознакомьтесь с нашим материалом по **проектированию Голограммы-Head и отслеживания взглядов** ниже:
...
в шоврумной работе от компания volvo автомобилей клиенты приглашаются к дополнительным сведениям о новых возможностях автомобилей в HoloLensном интерфейсе, посвященном компания volvo. Компания Volvo столкнулся с проблемой в holographic кадре: слишком большой автомобиль слишком велик для последующего размещения пользователя. Решением было начало работы с физическим ориентиром, Центральной таблицей в шоврум с небольшой цифровой моделью автомобиля, размещенной поверх таблицы. Это гарантирует, что пользователь видит полный автомобиль, когда он появился, позволяя понять понимание пространственного понимания по мере роста автомобиля до его реального масштаба в дальнейшем.
...
Опыт магазина от Лоу приглашает клиентов в полноценную макетноеию кухни, чтобы продемонстрировать различные возможности ремоделирования, как показано в HoloLens. Кухни в магазине включает в себя физический задниок для цифровых объектов, пустой холст устройств, каунтертопс и ящиков для unfold.
...
![лоу связывается с планшетом для клиентов с помощью HoloLensного интерфейса.](images/loweskitchen-750px.jpg)<br>
*лоу связывается с планшетом для клиентов с помощью HoloLensного интерфейса.*
...
в HoloLensных фрагментах вы живете в монтажной сцене, в которой отображаются подсказки и доказательства, а также виртуальная комната для собраний, где вы говорите с символами, расположенными на ваших стулах, и экономичными стенами.
