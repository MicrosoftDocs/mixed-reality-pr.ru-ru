...
| [Пример приложения для создания голограмм](https://www.microsoft.com/p/designing-holograms/9nxwnjklrzwd) | Изучите основные принципы разработки пользовательского интерфейса Смешанной реальности на практике, исследуя поведение в Смешанной реальности, а также получите советы и рекомендации для создания впечатляющих приложений HoloLens |
