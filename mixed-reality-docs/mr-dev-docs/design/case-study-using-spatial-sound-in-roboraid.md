...
description: пространственный звук — одна из наиболее интересных функций Microsoft HoloLens, позволяющая пользователям понять, что происходит над ними, когда объекты становятся недоступными.
author: mattzmsft
ms.author: hakons
ms.date: 03/21/2018
ms.topic: article
keywords: Windows Mixed Reality, HoloLens, робораид, пространственный звук, гарнитура смешанной реальности, гарнитура Windows mixed reality, гарнитура виртуальной реальности, HoloLens, мртк, набор средств смешанной реальности, цп
ms.openlocfilehash: f4a47fe119dffbd32d264cc8e21ae2b3ade7cfcccef8e7e18fbb4491783d0542
ms.sourcegitcommit: a1c086aa83d381129e62f9d8942f0fc889ffcab0
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 08/05/2021
ms.locfileid: "115209007"
---
...
в этой статье описываются проблемы, с которыми сталкивается группа Microsoft HoloLens Experience при создании звука для кораблей в смешанной среде ( [робораид](https://www.microsoft.com/p/roboraid/9nblggh5fv3j) ).

## <a name="the-tech"></a>Технический

[пространственный звук](spatial-sound.md) — одна из наиболее интересных функций Microsoft HoloLens, позволяющая пользователям понять, что происходит, когда объекты не находятся в области анализа.
...
создание пространственного звука для HoloLens приложений — это новое и уникальное решение проблемы, которое может быть трудно решить, так как на них нет ссылок на предыдущие проекты. Надеюсь, эти примеры проблем со звуком, которые мы столкнулись при создании Робораид, помогут вам создать звук для своих приложений.
...
интересной проблемой, которую мы столкнулись с HoloLens, было то, насколько сложно было эффективно взаимодействовать с игроком. Что делает работу в смешанной реальности успешной. Это означает, что вы должны быть уверены, что вы инопланетянин робота инвасион в собственной гостиной.
...
Я надеюсь, что у ИТ-специалистов будет столько удовольствия и приятно работать над собственными приложениями, как я работал над Робораид. Я не могу ждать (и слышать!) о том, что талантливые за пределами корпорации HoloLens Майкрософт.
