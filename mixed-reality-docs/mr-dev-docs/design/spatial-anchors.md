...
Для непрерывного масштабирования или размещения в помещении для головных телефонов настольных ПК, которые будут оставаться в пределах 5-метрического диаметра, обычно можно использовать [промежуточный кадр ссылки](coordinate-systems.md#stage-frame-of-reference) вместо пространственных привязок, который предоставляет единую систему координат для отображения всего содержимого. Однако если приложение позволяет пользователям рыскающего более 5 метров в HoloLens, возможно, на протяжении всего этажа здания, для обеспечения стабильной работы содержимого потребуются пространственные привязки.
