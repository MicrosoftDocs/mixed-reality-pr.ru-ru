...
2. если вы используете внешний Bluetooth адаптер USB вместо встроенного Bluetooth радио, ознакомьтесь с рекомендациями по [Bluetooth](/windows/mixed-reality/enthusiast-guide/troubleshooting-windows-mixed-reality#bluetooth-best-practices) перед продолжением. Для конфигурации рабочего стола с встроенным радио убедитесь, что антенна подключена.
3. откройте **Windows Параметры**  ->  **устройства**  ->  **добавить Bluetooth или другое устройство**  ->  **Bluetooth** и удалите все более ранние экземпляры "контроллер движения — справа" и "контроллер движения — слева". Проверьте также категорию Другие устройства в нижней части списка.
4. выберите **добавить Bluetooth или другое устройство** и посмотрите, как оно начинается для обнаружения устройств Bluetooth.
...
* **Главная** — это специальное системное действие, используемое для возврата в меню "Пуск". аналогично нажатию клавиши Windows на клавиатуре или кнопки xbox на контроллере xbox. вы можете зайти домой, нажав кнопку Windows на контроллере движения. обратите внимание, что всегда можно вернуться к началу, выполнив команду "эй Кортана," домой ". Приложения не могут реагировать на действия, относящиеся к домашним, так как они обрабатываются системой.
...
Встроенное по контроллера движения является частью драйвера гарнитуры и будет автоматически обновлено при подключении при необходимости. обновление встроенного по обычно занимает 1-2 минут в зависимости от Bluetooth радио и качества связи. в редких случаях обновление встроенного по контроллера может занять до 10 минут, что может указывать на плохое Bluetooth подключение или радиопомехи. сведения об устранении проблем с подключением см. [в разделе Bluetooth рекомендации](/windows/mixed-reality/enthusiast-guide/troubleshooting-windows-mixed-reality#bluetooth-best-practices) по работе с энтузиастами. После обновления встроенного по контроллеры перезапускаются и подключаются к главному компьютеру (вы можете заметить, что индикаторы будут освещены для отслеживания). Если обновление встроенного по прервано (например, при потере питания контроллеров), будет предпринята попытка повторного выполнения в следующий раз, когда контроллеры будут включены.

### <a name="how-i-can-check-battery-level"></a>Как можно проверить уровень заряда батареи?

на [домашней странице Windows Mixed Reality home](../discover/navigating-the-windows-mixed-reality-home.md)можно включить контроллер, чтобы увидеть уровень его аккумулятора на противоположной стороне виртуальной модели. Отсутствует индикатор физического аккумулятора.
