...
Приложения должны выполнять упрощение сетки только в том случае, если плотность треугольника, предоставляемая наблюдателем Surface, по-прежнему недостаточна. Эта работа является ресурсоемкой и уже выполняется средой выполнения для создания различных предоставленных уровней детализации.
...
> [Предположение масштаба объекта (масштабирование)](../design/scale.md)
