---
title: Создание удаленного приложения holographic с удаленным взаимодействием с помощью API Холографикспаце
...
ms.openlocfilehash: 87e1c36fe6144eb8c51160a15cd6bc1ec4a1682f
ms.sourcegitcommit: bea83261bf9ce7a27a618e5bc54dc4d7711f5435
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 10/19/2021
ms.locfileid: "130157820"
---
...
чтобы проверить правильность работы репроекции в HoloLens 2, можно включить визуализатор глубины с помощью портала устройств. Дополнительные сведения см. в разделе [Проверка глубины правильно настроена](../advanced-concepts/hologram-stability.md#verifying-depth-is-set-correctly) .
