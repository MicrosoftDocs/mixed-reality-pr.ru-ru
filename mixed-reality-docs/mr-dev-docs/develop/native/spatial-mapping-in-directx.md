...
В этом разделе описывается реализация [пространственного сопоставления](../../design/spatial-mapping.md) в приложении DirectX. Сюда входит подробное описание примера приложения пространственного сопоставления, которое входит в состав пакета SDK для универсальная платформа Windows.
...
- **Сетка приема и обработки**
  ...
  - Здесь приложение может при необходимости выполнять анализ или [обработку](../../design/spatial-mapping.md#mesh-processing) данных сетки, а также использовать их для [визуализации](../../design/spatial-mapping.md#rendering) и создания физических [райкастинг и конфликтов](../../design/spatial-mapping.md#raycasting-and-collision).
...
Эта возможность поступает из пространства имен **uap2** . Чтобы получить доступ к этому пространству имен в манифесте, включите его в качестве атрибута *кслмнс* в &lt; элемент Package>. Пример:
