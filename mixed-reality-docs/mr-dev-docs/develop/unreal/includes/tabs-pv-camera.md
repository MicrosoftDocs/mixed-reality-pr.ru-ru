...
- <span data-ttu-id="6c0e4-142">в файле CamCapture.h включите ARBlueprintLibrary.h:</span><span class="sxs-lookup"><span data-stu-id="6c0e4-142">In CamCapture.h, include ARBlueprintLibrary.h</span></span>
