...
если подключаемые модули Windows Mixed Reality и Live links включены:
...
- выберите свой ресурс **арсессионконфиг** , разверните параметры **универсального сопоставления AR Параметры >** и установите флажок **создать данные сетки из отслеживающей геометрии**.
...
3. Перезапись при добавлении, обновлении или удалении отслеживаний геометрии со следующими узлами в Graph событий:
