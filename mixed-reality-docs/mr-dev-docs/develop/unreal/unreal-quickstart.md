...
---
# <a name="creating-a-hololens-project"></a>Создание проекта HoloLens
...
4. Откройте схему уровня (**Level Blueprint**) и добавьте действия **InputAction RightPinch** и **InputAction LeftPinch**.
...
5. В параметрах **Transform** (Преобразование) для этого куба задайте параметру **Mobility** (Мобильность) значение **Movable** (Перемещаемый), чтобы объект мог динамически перемещаться:
