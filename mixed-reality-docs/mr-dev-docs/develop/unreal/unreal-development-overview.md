...
| [Настройка проекта](unreal-project-setup.md) | Получить последнюю версию Unreal Engine и MRTK |
...
| Начало работы с [OpenXR](../native/openxr.md) в Unreal | Установите и включите следующий подключаемый модуль из Unreal Engine Marketplace:<ul><li> [Microsoft OpenXR](https://www.unrealengine.com/marketplace/en-US/product/ef8930ca860148c498b46887da196239).</li></ul>Подключаемый модуль Microsoft Windows Mixed Reality должен быть отключен.<br><br>Полный список поддерживаемых сейчас функций в OpenXR приведен [ниже](#supported-features).|
