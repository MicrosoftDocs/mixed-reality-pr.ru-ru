...
Теперь, когда приложение UWP нацелено на "Windows. Universal ", давайте создадим свое приложение и запустим его в [HoloLens Emulator](../platform-capabilities-and-apis/using-the-hololens-emulator.md).
