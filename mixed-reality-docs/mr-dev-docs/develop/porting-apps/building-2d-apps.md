...
* Убедитесь, что пользовательский интерфейс соответствует рекомендациям по [проектированию для реагирования](https://msdn.microsoft.com/library/windows/apps/dn958435.aspx) на уникальные решения HOLOLENS и dpi.
