...
ms.openlocfilehash: baaddecbca2115200be62a428edecad825ff9958
ms.sourcegitcommit: bea83261bf9ce7a27a618e5bc54dc4d7711f5435
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 10/19/2021
ms.locfileid: "130158076"
---
# <a name="holographic-remoting-player-overview"></a>Общие сведения об удаленном проигрывателе holographic

> [!TIP]
> [Изучите основы голографического удаленного взаимодействия.](holographic-remoting-overview.md)

> [!IMPORTANT]
> holographic удаленное взаимодействие для HoloLens 2 является основным изменением версии. [удаленные приложения для **HoloLens (1-го поколения)**](../native/add-holographic-remoting.md) должны использовать NuGet пакета версии **1. x.** x и [удаленные приложения для **HoloLens 2**](../native/holographic-remoting-create-remote-wmr.md) должны использовать версию **2. x. x**. это означает, что удаленные приложения, написанные для HoloLens 2, несовместимы с HoloLens (1-го поколения) и наоборот.
...
> [!Note]
> начиная с версии [2.2.0](../native/holographic-remoting-version-history.md#v2.2.0) , также доступен плеер holographic для Windows пк под управлением [Windows Mixed Reality](../../discover/navigating-the-windows-mixed-reality-home.md).

> [!TIP]
> Начиная с версии [2.4.0](../native/holographic-remoting-version-history.md#v2.4.0) удаленные приложения можно создавать с помощью [API опенкср](../native/openxr.md) . Чтобы начать, ознакомьтесь с [написанием удаленного приложения holographic с удаленным взаимодействием с помощью API-интерфейсов опенкср](../native/holographic-remoting-create-remote-openxr.md).
...
* [HoloLens (первая общая): добавление удаленного взаимодействия holographic](../native/add-holographic-remoting.md)
* [создание удаленного приложения holographic с удаленным взаимодействием с помощью Windows Mixed Reality api](../native/holographic-remoting-create-remote-wmr.md)
