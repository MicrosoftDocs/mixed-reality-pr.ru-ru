...
Для впечатляющих головных телефонов настольных систем можно поддерживать виртуальные клавиатуры, отображаемые Windows в режиме погружения, путем реализации **коретекстедитконтекст**. Это позволяет Windows понять состояние собственных текстовых полей, отображаемых в приложении, поэтому виртуальная клавиатура может правильно участвовать в тексте.
...
Перекомпиляция и повторное развертывание. Обратите внимание, что нажатие кнопки мыши теперь перемещает куб в иммерсивное устройство или HoloLens с подключенной мышью по Bluetooth.
