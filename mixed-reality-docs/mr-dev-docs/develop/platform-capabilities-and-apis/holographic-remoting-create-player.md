...
ms.openlocfilehash: 055430e7084bdc0b86e09ca2517340b4e574ee76
ms.sourcegitcommit: 018a6edbab5011dd3b44ebf1dca017a731fcfca3
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 10/11/2021
ms.locfileid: "129745140"
---
# <a name="writing-a-custom-holographic-remoting-player-app-using-the-windows-mixed-reality-api"></a>написание настраиваемого приложения holographic для удаленного взаимодействия с помощью API Windows Mixed Reality
...
Дополнительные сведения см. [в статье о синхронизации системы координат с помощью удаленного взаимодействия с holographic](holographic-remoting-coordinate-system-synchronization.md).
