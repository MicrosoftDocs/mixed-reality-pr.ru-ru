...
* Расширение XR_MSFT_holographic_remoting_speech теперь позволяет повторно инициализировать распознаватель речи новыми параметрами во время выполнения сеанса.
...
* Улучшена производительность плеера holographic Remoting, доступного через Microsoft Store. в HoloLens 2 проигрыватель теперь работает в 60 кадрах в секунду.
...
* поддержка новых api перцептиондевице (Windows 10 обновления за ноябрь 2019).
