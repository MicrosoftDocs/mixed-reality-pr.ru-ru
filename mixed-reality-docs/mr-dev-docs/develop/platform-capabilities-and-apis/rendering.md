...
* Максимальный размер окна просмотра — это свойство [холографикдисплай](/uwp/api/windows.graphics.holographic.holographicdisplay). Для HoloLens задан максимальный размер окна просмотра, то есть 720p (1268x720) по умолчанию.
