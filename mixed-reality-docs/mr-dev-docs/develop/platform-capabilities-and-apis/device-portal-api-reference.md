...
возвращает список HoloLens отдельных поставщиков ETW, которые не зарегистрированы в системе.
...
ответ содержит свойство JSON, указывающее, будет ли Windows портал устройств записывать видео.
