...
Например, рассмотрим один из сценариев Skype из запуска HoloLens: пользователь поработал, [как исправить поврежденный коммутатор](https://www.youtube.com/watch?v=iBfzs3G8BEA) с помощью удаленного эксперта.
