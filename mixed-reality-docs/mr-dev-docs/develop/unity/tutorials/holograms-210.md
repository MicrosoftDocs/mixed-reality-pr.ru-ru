...
---
# <a name="hololens-1st-gen-input-210-gaze"></a>Входные данные HoloLens (1-го поколения) 210: Взгляните
...
3. Раскомментируйте строки в обратных вызовах **ифокусабле. онфокусентер ()** и **ифокусабле. онфокусексит ()** в **интерактибле. CS**. Они вызываются InputManager набора средств Mixed Reality, когда фокус (либо с помощью указателя мыши, либо с помощью контроллера) вводит и выходит из GameObjectа.
