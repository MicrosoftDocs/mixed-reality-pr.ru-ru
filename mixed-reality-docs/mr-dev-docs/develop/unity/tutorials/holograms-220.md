...
* <span data-ttu-id="d3c63-115">Настройка среды разработки для использования пространственного звука Майкрософт.</span><span class="sxs-lookup"><span data-stu-id="d3c63-115">Configure your development environment to use Microsoft Spatial Sound.</span></span>
...
### <a name="project-files"></a><span data-ttu-id="d3c63-133">Файлы проекта</span><span class="sxs-lookup"><span data-stu-id="d3c63-133">Project files</span></span>
...
### <a name="objectives"></a><span data-ttu-id="d3c63-147">Задачи</span><span class="sxs-lookup"><span data-stu-id="d3c63-147">Objectives</span></span>
...
<span data-ttu-id="d3c63-167">Теперь создадим проект в Unity и настроим решение в Visual Studio.</span><span class="sxs-lookup"><span data-stu-id="d3c63-167">We will now build the project in Unity and configure the solution in Visual Studio.</span></span>
...
#### <a name="key-concepts"></a><span data-ttu-id="d3c63-218">Основные понятия</span><span class="sxs-lookup"><span data-stu-id="d3c63-218">Key Concepts</span></span>
...
#### <a name="key-concepts"></a><span data-ttu-id="d3c63-233">Основные понятия</span><span class="sxs-lookup"><span data-stu-id="d3c63-233">Key Concepts</span></span>
...
1. <span data-ttu-id="d3c63-248">В Unity выберите **файл > параметры сборки**.</span><span class="sxs-lookup"><span data-stu-id="d3c63-248">In Unity, select **File > Build Settings**.</span></span>
...
### <a name="objectives"></a><span data-ttu-id="d3c63-266">Задачи</span><span class="sxs-lookup"><span data-stu-id="d3c63-266">Objectives</span></span>
...
* <span data-ttu-id="d3c63-278">**Коснитесь, чтобы поместить звук и действие**:</span><span class="sxs-lookup"><span data-stu-id="d3c63-278">In **Tap To Place With Sound and Action**:</span></span>
  ...
  * <span data-ttu-id="d3c63-282">Нажмите кнопку + в правом нижнем углу в разделе **действие отправки** и **действие при размещении**.</span><span class="sxs-lookup"><span data-stu-id="d3c63-282">Press the + in the bottom right under both **On Pickup Action** and **On Placement Action**.</span></span> <span data-ttu-id="d3c63-283">Перетащите Енергихуб из сцены в поля **нет (объект)** .</span><span class="sxs-lookup"><span data-stu-id="d3c63-283">Drag EnergyHub from the scene into the **None (Object)** fields.</span></span>
    ...
    * <span data-ttu-id="d3c63-285">В разделе **действие при размещении** щелкните **нет функции**  ->  **енергихуббасе**  ->  **OnSelect**.</span><span class="sxs-lookup"><span data-stu-id="d3c63-285">Under **On Placement Action**, click on **No Function** -> **EnergyHubBase** -> **OnSelect**.</span></span>
...
#### <a name="build-and-deploy"></a><span data-ttu-id="d3c63-334">Построение и Развертывание</span><span class="sxs-lookup"><span data-stu-id="d3c63-334">Build and Deploy</span></span>
...
<span data-ttu-id="d3c63-351">При создании сценария виртуальной реальности выберите модель комнаты, которая лучше подходит для виртуальной среды.</span><span class="sxs-lookup"><span data-stu-id="d3c63-351">If you are creating a Virtual Reality scenario, select the room model that best fits the virtual environment.</span></span>
...
#### <a name="emit-sound-from-logical-locations-on-your-holograms"></a><span data-ttu-id="d3c63-364">Выдавать звук из логических расположений на голограммах</span><span class="sxs-lookup"><span data-stu-id="d3c63-364">Emit sound from logical locations on your holograms</span></span>
...
#### <a name="avoid-hidden-emitters"></a><span data-ttu-id="d3c63-378">Избегайте скрытых передатчиков</span><span class="sxs-lookup"><span data-stu-id="d3c63-378">Avoid hidden emitters</span></span>
...
#### <a name="use-the-unity-audiomixer-to-adjust-categories-of-sounds"></a><span data-ttu-id="d3c63-394">Настройка категорий звуков с помощью Unity Аудиомиксер</span><span class="sxs-lookup"><span data-stu-id="d3c63-394">Use the Unity AudioMixer to adjust categories of sounds</span></span>
...
<span data-ttu-id="d3c63-420">Звуковые данные могут быть большими, особенно в общих частотах выборки (44,1 и 48 кГц).</span><span class="sxs-lookup"><span data-stu-id="d3c63-420">Audio data can be large, especially at common sample rates (44.1 and 48 kHz).</span></span> <span data-ttu-id="d3c63-421">Общее правило заключается в потоковой передаче звуковых файлов дольше 5-10 секунд, чтобы сократить использование памяти приложения.</span><span class="sxs-lookup"><span data-stu-id="d3c63-421">A general rule is that audio files longer than 5 - 10 seconds should be streamed to reduce application memory usage.</span></span>
...
<span data-ttu-id="d3c63-436">В **воицесаурце** будет добавлен компонент **аудиосаурце** .</span><span class="sxs-lookup"><span data-stu-id="d3c63-436">An **AudioSource** component will be added to **VoiceSource**.</span></span>
...
* <span data-ttu-id="d3c63-448">Установите для параметра **исходный звуковой том** значение **0,5**.</span><span class="sxs-lookup"><span data-stu-id="d3c63-448">Set **Original Sound Volume** to **0.5**.</span></span>

<span data-ttu-id="d3c63-449">Предыдущие параметры настраивают параметры **Аудиочорусфилтер** Unity, используемые для добавления богатости в речь пользователя.</span><span class="sxs-lookup"><span data-stu-id="d3c63-449">The previous settings configure the parameters of the Unity **AudioChorusFilter** used to add richness to the user's voice.</span></span>

* <span data-ttu-id="d3c63-450">В окне " **Пользовательский Видеорезультат**" разверните **Параметры Echo**.</span><span class="sxs-lookup"><span data-stu-id="d3c63-450">In **User Voice Effect**, expand **Echo Parameters**.</span></span>
* <span data-ttu-id="d3c63-451">Установить **задержку** в **300**</span><span class="sxs-lookup"><span data-stu-id="d3c63-451">Set **Delay** to **300**</span></span>
* <span data-ttu-id="d3c63-452">Установите **соотношение Decay** к **0,2**.</span><span class="sxs-lookup"><span data-stu-id="d3c63-452">Set **Decay Ratio** to **0.2**.</span></span>
* <span data-ttu-id="d3c63-453">Установите **0** в качестве **исходного звукового тома** .</span><span class="sxs-lookup"><span data-stu-id="d3c63-453">Set **Original Sound Volume** to **0**.</span></span>

<span data-ttu-id="d3c63-454">Предыдущие параметры настраивают параметры **Аудиоечофилтер** Unity, которые приводят к эхо голоса пользователя.</span><span class="sxs-lookup"><span data-stu-id="d3c63-454">The previous settings configure the parameters of the Unity **AudioEchoFilter** used to cause the user's voice to echo.</span></span>

<span data-ttu-id="d3c63-455">Сценарий пользовательского голоса отвечает за следующее:</span><span class="sxs-lookup"><span data-stu-id="d3c63-455">The User Voice Effect script is responsible for:</span></span>

* <span data-ttu-id="d3c63-456">Измерение расстояния между пользователем и **GameObject** , к которому присоединен скрипт.</span><span class="sxs-lookup"><span data-stu-id="d3c63-456">Measuring the distance between the user and the **GameObject** to which the script is attached.</span></span>
* <span data-ttu-id="d3c63-457">Определение того, находится ли пользователь в **GameObject**.</span><span class="sxs-lookup"><span data-stu-id="d3c63-457">Determining whether or not the user is facing the **GameObject**.</span></span>

<span data-ttu-id="d3c63-458">Для включения этого действия пользователь должен быть направлен на GameObject, независимо от расстояния.</span><span class="sxs-lookup"><span data-stu-id="d3c63-458">The user must be facing the GameObject, regardless of distance, for the effect to be enabled.</span></span>

* <span data-ttu-id="d3c63-459">Применение и настройка **аудиочорусфилтер** и **аудиоечофилтер** для **аудиосаурце**.</span><span class="sxs-lookup"><span data-stu-id="d3c63-459">Applying and configuring an **AudioChorusFilter** and an **AudioEchoFilter** to the **AudioSource**.</span></span>
* <span data-ttu-id="d3c63-460">Отключение этого действия путем отключения фильтров.</span><span class="sxs-lookup"><span data-stu-id="d3c63-460">Disabling the effect by disabling the filters.</span></span>

<span data-ttu-id="d3c63-461">В голосовом режиме для пользователя используется компонент выбора потока MIC из [микседреалититулкит для Unity](https://github.com/Microsoft/MixedRealityToolkit-Unity), чтобы выбрать высококачественный голосовой поток и направить его в звуковую систему Unity.</span><span class="sxs-lookup"><span data-stu-id="d3c63-461">User Voice Effect uses the Mic Stream Selector component, from the [MixedRealityToolkit for Unity](https://github.com/Microsoft/MixedRealityToolkit-Unity), to select the high quality voice stream and route it into Unity's audio system.</span></span>

* <span data-ttu-id="d3c63-462">На панели **Иерархия** выберите **Диспетчеры**.</span><span class="sxs-lookup"><span data-stu-id="d3c63-462">In the **Hierarchy** panel, select **Managers**.</span></span>
* <span data-ttu-id="d3c63-463">На панели **инспектора** разверните **обработчик речевого ввода**.</span><span class="sxs-lookup"><span data-stu-id="d3c63-463">In the **Inspector** panel, expand **Speech Input Handler**.</span></span>
* <span data-ttu-id="d3c63-464">В **обработчике речевого ввода** разверните узел **Показывать подсветку**.</span><span class="sxs-lookup"><span data-stu-id="d3c63-464">In **Speech Input Handler**, expand **Show Underworld**.</span></span>
* <span data-ttu-id="d3c63-465">Не изменяйте **функцию** на **Ундерворлдбасе. OnEnable**.</span><span class="sxs-lookup"><span data-stu-id="d3c63-465">Change **No Function** to **UnderworldBase.OnEnable**.</span></span>

![Ключевое слово: показывать подсветку](images/showunderworld.png)

* <span data-ttu-id="d3c63-467">Разверните узел **Скрыть подсветку**.</span><span class="sxs-lookup"><span data-stu-id="d3c63-467">Expand **Hide Underworld**.</span></span>
* <span data-ttu-id="d3c63-468">Не изменяйте **функцию** на **Ундерворлдбасе. ondisable**.</span><span class="sxs-lookup"><span data-stu-id="d3c63-468">Change **No Function** to **UnderworldBase.OnDisable**.</span></span>

![Ключевое слово: Скрыть подсветку](images/hideunderworld.png)

#### <a name="build-and-deploy"></a><span data-ttu-id="d3c63-470">Построение и Развертывание</span><span class="sxs-lookup"><span data-stu-id="d3c63-470">Build and Deploy</span></span>

* <span data-ttu-id="d3c63-471">Как и ранее, создайте проект в Unity и разверните его в Visual Studio.</span><span class="sxs-lookup"><span data-stu-id="d3c63-471">As before, build the project in Unity and deploy in Visual Studio.</span></span>

<span data-ttu-id="d3c63-472">После развертывания приложения:</span><span class="sxs-lookup"><span data-stu-id="d3c63-472">After the application is deployed:</span></span>

* <span data-ttu-id="d3c63-473">Лицевая поверхность (стена, этаж, таблица) и скажите *«Показывать подсветку»*.</span><span class="sxs-lookup"><span data-stu-id="d3c63-473">Face a surface (wall, floor, table) and say *"Show Underworld"*.</span></span>

<span data-ttu-id="d3c63-474">Будет отображена подсветка, а все остальные голограммы будут скрыты.</span><span class="sxs-lookup"><span data-stu-id="d3c63-474">The underworld will be shown and all other holograms will be hidden.</span></span> <span data-ttu-id="d3c63-475">Если вы не видите подсветку, убедитесь, что вы используете реальную поверхность.</span><span class="sxs-lookup"><span data-stu-id="d3c63-475">If you do not see the underworld, ensure that you are facing a real-world surface.</span></span>

* <span data-ttu-id="d3c63-476">Подход в пределах 1 индикатора немалой голограммы и начните говорить.</span><span class="sxs-lookup"><span data-stu-id="d3c63-476">Approach within 1 meter of the underworld hologram and start talking.</span></span>

<span data-ttu-id="d3c63-477">Теперь на ваш голос применяются звуковые эффекты!</span><span class="sxs-lookup"><span data-stu-id="d3c63-477">There are now audio effects applied to your voice!</span></span>

* <span data-ttu-id="d3c63-478">Отключитесь от подсветки и обратите внимание на то, как это действие больше не применяется.</span><span class="sxs-lookup"><span data-stu-id="d3c63-478">Turn away from the underworld and notice how the effect is no longer applied.</span></span>
* <span data-ttu-id="d3c63-479">Скажите *«Скрыть подсветку»* , чтобы скрыть подсветку.</span><span class="sxs-lookup"><span data-stu-id="d3c63-479">Say *"Hide Underworld"* to hide the underworld.</span></span>

<span data-ttu-id="d3c63-480">Подсветка будет скрыта, и ранее скрытые голограммы будут отображаться снова.</span><span class="sxs-lookup"><span data-stu-id="d3c63-480">The underworld will be hidden and the previously hidden holograms will reappear.</span></span>

## <a name="the-end"></a><span data-ttu-id="d3c63-481">Конец</span><span class="sxs-lookup"><span data-stu-id="d3c63-481">The End</span></span>

<span data-ttu-id="d3c63-482">Поздравляем!</span><span class="sxs-lookup"><span data-stu-id="d3c63-482">Congratulations!</span></span> <span data-ttu-id="d3c63-483">Теперь вы завершили выполнение пространственного **пространственного 220: Пространственный звук**.</span><span class="sxs-lookup"><span data-stu-id="d3c63-483">You have now completed **MR Spatial 220: Spatial sound**.</span></span>

<span data-ttu-id="d3c63-484">Прослушайтесь в мире и поработайте со звуком!</span><span class="sxs-lookup"><span data-stu-id="d3c63-484">Listen to the world and bring your experiences to life with sound!</span></span>