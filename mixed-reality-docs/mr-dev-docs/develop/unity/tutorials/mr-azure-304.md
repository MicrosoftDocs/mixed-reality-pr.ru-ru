...
---
# <a name="mr-and-azure-304-face-recognition"></a>304. Смешанная реальность и Azure: распознавание лиц
...
>
> -  *Train* Обучить *службу API распознавания лиц Azure*.
...
7. На этой панели необходимо проверить несколько параметров:
    ...
    1. На вкладке **другие параметры** выполните следующие действия.
        ...
        1. **Scripting** **Версия среды выполнения** сценариев должна быть **экспериментальной** (эквивалент .NET 4,6). Изменение этого триггера приведет к необходимости перезапуска редактора.
