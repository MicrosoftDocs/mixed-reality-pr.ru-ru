...
В окне Import package (Импорт пакета) выберите скачанный файл **Microsoft.MixedReality.Toolkit.Unity.Foundation.2.5.1.unitypackage** и нажмите кнопку **Open** (Открыть):
