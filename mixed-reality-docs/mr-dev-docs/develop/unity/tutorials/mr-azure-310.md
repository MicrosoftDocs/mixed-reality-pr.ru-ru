...
- ПК для разработки
- [Windows 10 Fall Creators Update (или более поздней версии) с включенным режимом разработчика](/windows/mixed-reality/install-the-tools#installation-checklist-for-hololens)
...
7.  чтобы выполнить развертывание на Microsoft HoloLens, вам потребуется IP-адрес этого устройства (для удаленного развертывания) и убедиться, что в нем также установлен **режим разработчика** . Выполните указанные ниже действия.
