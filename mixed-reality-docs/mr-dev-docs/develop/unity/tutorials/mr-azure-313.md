...
---
# <a name="hololens-1st-gen-and-azure-313-iot-hub-service"></a>HoloLens (1-й общий) и Azure 313: служба центра Интернета вещей
...
1. Настройка и тестирование HoloLens. Если вам нужна поддержка по настройке HoloLens, [обязательно посетите статью Настройка hololens](/hololens/hololens-setup).
...
3. Настройте **виртуальную машину Ubuntu** с помощью **Hyper-V**. Следующие ресурсы помогут вам в процессе.
    ...
    2.  Убедитесь, что на компьютере с Windows 10 включен **Hyper-V** . Вы можете перейти по этой ссылке, чтобы получить рекомендации по [установке и включению Hyper-V в Windows 10](/virtualization/hyper-v-on-windows/quick-start/enable-hyper-v).
