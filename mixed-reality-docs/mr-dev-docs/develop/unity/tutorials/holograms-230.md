...
---
# <a name="hololens-1st-gen-spatial-230-spatial-mapping"></a>Картографический (1-й) пространственный 230: пространственное сопоставление
...
* Вернитесь в Visual Studio и откройте **спатиалмаппингобсервер. CS**. Он будет находиться в папке Холотулкит\спатиалмаппинг проекта Assembly-CSharp (универсальные приложения для Windows).
...
* На панели **проект** в папке **скрипты** дважды щелкните **размещенный. CS** , чтобы открыть его в Visual Studio.
