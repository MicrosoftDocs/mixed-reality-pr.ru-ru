...
Теперь вы можете написать функцию **Azure** **Function** в службе Azure.
...
6.  Далее предстоит создать **трехмерный текстовый** объект, чтобы оставить отзыв о состоянии службы Azure.
    ...
    Щелкните правой кнопкой мыши **газебуттон** на панели Иерархия и добавьте трехмерный **3D Object** трехмерный объект  >  **3D** Object в качестве *дочернего* .
...
1.  Добавьте файл **. пакет unitypackage** в Unity с помощью команды **Assets**  >  **Import Package**  >  меню **настраиваемый пакет** импорт активов.

2.  В появившемся окне **Импорт пакета Unity** можно выбрать все в разделе хранилище **подключаемых модулей**  >  **Storage** . Снимите флажок все остальное, так как он не требуется для этого курса.
...
1.  Перейдите в **File** раздел  >  **параметры сборки** файлов.
