...
ms.locfileid: "115212138"
---
# <a name="performance-recommendations-for-unity"></a>Рекомендации по производительности для Unity

Эта статья продолжает статью о [рекомендациях по оптимизации производительности для смешанной реальности](../platform-capabilities-and-apis/understanding-performance-for-mixed-reality.md), но посвящена улучшениям для Unity.
