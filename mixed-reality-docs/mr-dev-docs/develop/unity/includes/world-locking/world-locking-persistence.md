...
ms.locfileid: "123244263"
---
# <a name="world-locking-tools-recommended"></a>[Средства блокировки по всему миру (рекомендуется)](#tab/wlt)

По умолчанию средства блокировки мира восстанавливают систему координат Unity относительно физического мира во всех сеансах на устройствах, поддерживающих сохранение локальных пространственных привязок. Чтобы появилась голограмма в том же месте физического мира, что и при выходе и повторном запуске приложения, самая голограмма должна снова быть той же самой.
...
сохранение локальной привязки в настоящее время поддерживается только в семействе HoloLens устройств. однако в Android и iOS, а также HoloLens, сохраняемость координатных пространств между сеансами, а также совместное использование пространств координат на разных устройствах, поддерживается через интеграцию с пространственными привязками Azure. Множество [Дополнительные сведения и примеры](https://microsoft.github.io/MixedReality-WorldLockingTools-Unity/DocGen/Documentation/HowTos/WLT_ASA.html) использования международных средств блокировки в сочетании с пространственными привязками Azure.
