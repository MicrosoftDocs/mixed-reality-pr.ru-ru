...
когда проект будет готов к работе, запустите программу настройки сцены из **смешанной реальности набор средств > служебные программы > средства блокировки мира**:
