...
Windows Mixed Reality позволяет получить некоторые дополнительные возможности и функции:
...
Из-за более высокого разрешения следующие требования применяются к строкам продуктов HP Re & G2, чтобы обеспечить оптимальную работу 90Hz, полное разрешение: 
...
Для всех остальных ХМД обратитесь к следующим требованиям. 
...
* Более крупные переносные компьютеры (с экранами по крайней мере 15 ") работают лучше всего.
...
* Если у вас есть дискретная графическая карта, которая должна работать под управлением Windows Mixed Reality Ultra, но по умолчанию используется частота обновления 60 Гц (60 кадров в секунду), используйте адаптер Дисплайпорт HDMI 2,0, чтобы подключить гарнитуру и включить частоту обновления 90 Гц.
...
<tr>
        <td style="vertical-align: middle"> Контактная книга 2 (15 &quot; ) </td><td style="vertical-align: middle"> Полная архивация </td><td style="vertical-align: middle"> Intel Core i7/NVIDIA ГТКС 1060/16 ГБ ОЗУ </td>
        <td>
            <ul>
                <li><b>Рекомендуется</b>. для оптимальной работы Windows Mixed Reality на устройстве Surface рекомендуется использовать сурфацебук 2 15 ", настроенный с NVIDIA GeForce гткс 1060 и 16 ГБ ОЗУ.  Эта конфигурация протестирована и имеет эмблему Windows Mixed Reality Ultra, поэтому она будет поддерживать все функции Windows Mixed Reality и позволит вам использовать самые широко заданный массив совместимых приложений и игр.</li>
                <li>Дискретный GPU NVIDIA GeForce ГТКС 1060 обеспечивает интерфейс Windows Mixed Reality Ultra @ 90Hz</li><br/>                <li>Для достижения оптимальной производительности используйте графические драйверы NVIDIA, специально выпущенные для контактной книги 2. Новые драйверы могут быть доступны на веб-сайте NVIDIA&#39;s, но не проверяются.</li><br/>                <li>Требуется <a href="https://www.microsoft.com/en-us/store/d/surface-usb-c-to-hdmi-adapter/94chb2m80s54/4gj5">адаптер HDMI USB-C в качестве адаптера</a> (другие адаптеры могут работать, но не проверяются).</li>
    ...
    <tr>
        <td style="vertical-align: middle"> Контактная книга 2 (13,5 &quot; ) </td><td style="vertical-align: middle"> Partial </td><td style="vertical-align: middle"> Intel Core i7/NVIDIA ГТКС 1050/16 ГБ ОЗУ </td>
        <td>
            <ul>
                <li><b>Примечание</b>. Контактная книга 2 (13) не имеет эмблемы для Windows Mixed Reality, но поддерживает некоторые функции Windows Mixed Reality, позволяющие использовать ограниченное число совместимых приложений и игр.  Производительность будет зависеть от конфигурации.</li>
                <li>Конфигурации с интегрированным графическим процессором Intel Core i5/Интел HD 620 обеспечивают возможности Windows Mixed Reality @ 60 Гц</li>
                <li>Конфигурации с дискретным графическим процессором Intel Core i7/NVIDIA GeForce ГТКС 1050 будут предоставлять возможности Windows Mixed Reality @ 90Hz</li>                       <li>Для достижения оптимальной производительности используйте графические драйверы NVIDIA, специально выпущенные для контактной книги 2. Новые драйверы могут быть доступны на веб-сайте NVIDIA&#39;s, но не проверяются.</li>
    ...
    <tr>
        <td style="vertical-align: middle"> Surface Studio </td><td style="vertical-align: middle"> Partial </td><td style="vertical-align: middle"> Intel Core i7/NVIDIA GeForce ГТКС 980m/16 ГБ ОЗУ </td>
        <td>
            <ul>
                ...
                <li>Конфигурации с NVIDIA GeForce ГТКС 965m будут предоставлять возможности Windows Mixed Reality @ 60 Гц.</li>
                <li>Конфигурации с NVIDIA GeForce ГТКС 980m обеспечивают работу Windows Mixed Reality @ 90Hz.</li>
    ...
    <tr>
        <td style="vertical-align: middle"> Surface Pro (2017) </td><td style="vertical-align: middle"> Partial </td><td style="vertical-align: middle"> Intel Core i7/Intel® IRI™ плюс график 640/16 ГБ ОЗУ </td>
        <td>
            <ul>
                <li><b>Примечание</b>. Surface Pro (2017) не имеет эмблемы для Windows Mixed Reality, но будет поддерживать некоторые функции Windows Mixed Reality, позволяющие использовать ограниченное число совместимых приложений и игр.  Производительность будет зависеть от конфигурации.</li>
                <li>Конфигурации с интегрированным графическим процессором Intel Core M3/Intel HD 615 <b>не поддерживаются</b></li>
                <li>Конфигурации с интегрированным графическим процессором Intel Core i5/Интел HD 620 обеспечивают возможности Windows Mixed Reality @ 60 Гц</li>
                <li>Конфигурации с интегрированным графическим процессором Intel Core i7/Intel® IRI™ и Graphics 640 будут предоставлять возможности Windows Mixed Reality @ 60 Гц</li><br/><li>Требуется мини-Дисплайпорт Surface для устройства HDMI 2,0 (другие адаптеры могут работать, но не проверяются).</li>
        ...
        <td style="vertical-align: middle"> Ноутбук Surface </td><td style="vertical-align: middle"> Partial </td><td style="vertical-align: middle"> Intel Core i7/Intel® IRI™ плюс график 640/16 ГБ ОЗУ </td>
        <td>
            <ul>
