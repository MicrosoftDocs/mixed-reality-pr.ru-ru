...
## <a name="i-have-all-cables-connected-to-the-headset-and-pc-but-it-wont-turn-on"></a>Все кабели подключены к гарнитуре и компьютеру, но не будут включены

Убедитесь, что кабель, подключенный к гарнитуре, полностью установлен. В верхней части кабеля есть небольшая точка, которая будет выровняться рядом с верхней границей гарнитуры, когда она была полностью вставлена:

![Маленькая точка в верхней части кабеля](images/small-dot.jpg)
