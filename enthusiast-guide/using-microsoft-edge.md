...
Новый Microsoft ребр принимает [проект Chromium с открытым исходным кодом](https://blogs.windows.com/windowsexperience/2018/12/06/microsoft-edge-making-the-web-better-through-more-open-source-collaboration/) на рабочем столе. Это обеспечивает лучшую совместимость для клиентов и меньше фрагментации для веб-разработчиков. Он также поддерживает Вебкср при запуске, который является новым стандартом для создания впечатляющих веб-интерфейсов для головных телефонов VR вместо Вебвр.
...
После установки Windows 10 версии 1903 или более поздней вы будете готовы к использованию нового Microsoft ребра. Новый Microsoft ребр выполняется с помощью Центр обновления Windows, но вы можете вручную установить новый Microsoft ребро с [веб-сайта Microsoft ребра](https://www.microsoft.com/edge) , если хотите.
